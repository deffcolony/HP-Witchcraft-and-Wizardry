...
songs ={"MOD/resources/snd/harryhouseknmicrowave.ogg",
        "MOD/resources/snd/harryhouseknmicrowave.ogg"}
...
function init()
  ...
  breakSound = LoadSound("MOD/resources/snd/insertname2.ogg")
  nextSongSound = LoadSound("MOD/resources/snd/RadioNextSongSound.ogg")
  OnOffSound = LoadSound("MOD/resources/snd/harryhouseknmicrowaveONOFF.ogg")
  
  myRadio = FindShape("harryhousemicrowave", true)
  powerbutton = FindShape("microwavepower", true)
